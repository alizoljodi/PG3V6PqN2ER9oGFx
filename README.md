...
You can view the Tableau dashboard here: ![Tableau Link]([https://public.tableau.com/app/profile/ali.zoljodi/viz/term_deposit_feature_analysis/Dashboard2?publish=yes](https://public.tableau.com/views/term_deposit_feature_analysis/Dashboard2?:language=en-US&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link))
